...
class FormSimplified {
  ...
  /// Returns the Content of the form produced based on the Json descriptor file
  /// It just contains the fields and the buttons
  /// The fields must be then encapsulated into a Form (see blow)
  ...
  /// Return the form. The widget passed as argument must contain all fields generated by [getFormContent] method
  /// For an example of integration you can check the method below.
  Widget getForm(
      FormBuilderConfiguration configuration, Widget fieldsContainer) {
    return FormBuilder(
  ...
  ///         future: aFormSimplifiedInstance.getFormContent(widget.configuration, context),
  ///         builder: (BuildContext context, AsyncSnapshot<WidgetBuilderResult> snapshot) {
  ///   ...
...
class _FormWithDefaultLayoutState extends State<_FormWithDefaultLayout> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: FutureBuilder<WidgetBuilderResult>(
          future: widget.easyForm.getFormContent(widget.configuration, context),
          builder: (BuildContext context,
              AsyncSnapshot<WidgetBuilderResult> snapshot) {
            switch (snapshot.connectionState) {
              ...
              default:
                if (snapshot.hasError) {
                  ...
                  children.add(Row(
                    children: <Widget>[
                      Expanded(child: snapshot.data!.submit!),
                      const SizedBox(width: 20),
                      Expanded(
                        child: snapshot.data!.cancel!,
                      ),
